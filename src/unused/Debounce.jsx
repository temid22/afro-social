...
//this is an unsed component just stored here for future!
//this has to do with using debounce for effective search performance
// it delays the render by some milliseconds
const User = ({ user }) => {
  return (
  ...
  return (
    <div className='h-full flex flex-col w-full items-center p-12'>
      <form className='flex justify-center w-1/2 mb-12'>
        <SearchBarInput value={value} onChange={handleSearchInputChange} />
      </form>
